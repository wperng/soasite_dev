...
class Project(models.Model):
    ...
    endDate = models.DateTimeField(null=True, blank=True, verbose_name="Date Ended")
...
class Signoff(models.Model):
    ...
    sodate = models.DateTimeField(null=True, blank=True, verbose_name="SO Date")
    note = models.CharField(max_length=500, blank=True, verbose_name="Note")

    def __str__(self):
        return self.project.name + ": " + self.soteam
